...
if __name__ == '__main__':
	...
	result_2 = np.dot(H_2, current_pos)
	print("Transformation 2: \n", result_2)
	
	#transformation 3
	H_3 = np.matmul(p2.Tx(2.5), np.matmul(p2.Tz(0.5), p2.Ty(-1.5))) 
	result_3 = np.dot(H_3, Fixed_Frame)
	print("Transformation 3: \n", H_3)
	
	#transformation 4 
	H_4 = np.matmul(p2.Tz(0.5), np.matmul(p2.Tx(2.5), p2.Ty(-1.5)))
	result_4 = np.dot(H_3, Fixed_Frame)
	print("Transformation 3: \n", H_4)
